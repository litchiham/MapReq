...
def home():
    print("进入主页")
    return redirect('map?state=AK&siteType=private&siteType=psap&siteType=district&customerSegment=crisisgoClient&customerSegment=potentialCrisisgoClient&customerSegment=E911Client&customerSegment=psapClient')
